      ...
      <div className={classes.section}>
        <Grid container>
          <Grid item xs={12} sm={12} md={6}>
            <img className={classes.img} src={require("assets/img/widescreen-1.jpg")} alt={'{frontend image}'} />
          </Grid>
          <Grid item xs={12} sm={12} md={6}>
            <div className={classes.body}>
              ...
              <Item title={'NDIS Audit Systems'} content={'We provide modern Man development practices for NDIS providers without outdated paper systems.'}/>
            </div>
          </Grid>
        </Grid>
      </div>
